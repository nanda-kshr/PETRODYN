  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-[10px] text-gray-500 font-mono">SHIFT (6–24H) &amp; CYCLE (1–7D) HORIZONS</span>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 flex flex-col justify-between space-y-3">
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-[10px] px-2 py-0.5 rounded font-mono font-bold bg-emerald-50 text-emerald-700 border border-emerald-200">
                {prod.current_bopd} Now
              </span>
            </div>
            <div className="flex items-center gap-1.5 text-[10px] text-gray-500 font-mono">
              <span className="px-1.5 py-0.5 rounded bg-gray-100 text-emerald-700">Next 6–24 h</span>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-2.5 space-y-1.5">
            <div className="flex justify-between font-mono text-xs">
              <span className="text-gray-500">+6h: <strong className="text-gray-800">{prod.forecast_6h_bopd ?? prod.current_bopd}</strong></span>
              <span className="text-gray-500">+24h: <strong className="text-gray-800">{prod.forecast_24h_bopd ?? (prod.current_bopd - 1.0)}</strong></span>
            </div>
            <p className="text-[11px] text-emerald-700 font-mono font-medium pt-0.5">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 flex flex-col justify-between space-y-3">
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <span className="text-gray-700 font-medium text-xs flex items-center gap-1">
                <Zap className="w-3.5 h-3.5 text-sky-600" /> Energy (kWh/bbl)
                <Tooltip
              ...
              <span className="text-[10px] px-2 py-0.5 rounded font-mono font-bold bg-sky-50 text-sky-700 border border-sky-200">
                {energy.current_kwh_per_bbl} Now
              </span>
            </div>
            <div className="flex items-center gap-1.5 text-[10px] text-gray-500 font-mono">
              <span className="px-1.5 py-0.5 rounded bg-gray-100 text-sky-700">Next 6–24 h</span>
              <span>&bull; Upd: 15–60m</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-2.5 space-y-1.5">
            <div className="flex justify-between font-mono text-xs">
              <span className="text-gray-500">+6h: <strong className="text-gray-800">{energy.forecast_6h_kwh_per_bbl ?? energy.current_kwh_per_bbl}</strong></span>
              <span className="text-gray-500">+24h: <strong className="text-gray-800">{energy.forecast_24h_kwh_per_bbl ?? energy.current_kwh_per_bbl}</strong></span>
            </div>
            <p className="text-[11px] text-sky-700 font-mono font-medium pt-0.5">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 flex flex-col justify-between space-y-3">
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <span className="text-gray-700 font-medium text-xs flex items-center gap-1">
                <TrendingDown className="w-3.5 h-3.5 text-amber-600" /> Cooling Rate
                <Tooltip
              ...
              <span className="text-[10px] px-2 py-0.5 rounded font-mono font-bold bg-amber-50 text-amber-700 border border-amber-200">
                {cooling.cooling_rate_c_per_day}&deg;C/d
              </span>
            </div>
            <div className="flex items-center gap-1.5 text-[10px] text-gray-500 font-mono">
              <span className="px-1.5 py-0.5 rounded bg-gray-100 text-amber-700">Next 1–7 days</span>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-2.5 space-y-1">
            ...
            <span className="text-[10px] text-gray-500 block font-mono">
              Re-steam window: ~{cooling.recommended_css_resteam_window_days} days
            </span>
          </div>
        </div>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 flex flex-col justify-between space-y-3">
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <span className="text-gray-700 font-medium text-xs flex items-center gap-1">
                <Flame className="w-3.5 h-3.5 text-rose-600" /> Cycle SOR
                <Tooltip
              ...
              <span className="text-[10px] px-2 py-0.5 rounded font-mono font-bold bg-rose-50 text-rose-700 border border-rose-200">
                {sor.current_sor_forecast} Ratio
              </span>
            </div>
            <div className="flex items-center gap-1.5 text-[10px] text-gray-500 font-mono">
              <span className="px-1.5 py-0.5 rounded bg-gray-100 text-rose-700">Next 1–7 days</span>
              <span>&bull; Upd: 1–6h</span>
            </div>
          </div>
